...
rules = {
    ...
    'word1': ["Sky","Cloud","Mystic","Magic","Mango","Strawberry","Palm","Bounce","Spring","Jump","Zoom","Star","Moon","Jungle","Undergound","Aqua","Gimmick","Gadget","Tricky","Secret","Crystal","Emerald","Tropical","Flying","Wing","Death","Rocket","Palm Tree","Wacky","Quartz","Stardust","Galaxy","Dazzle","Mecha","Electric","Sleeping","Nighttime","Grassy","Lava","Toxic","Chemical","Machine","Metal","Ice","Angel","Snow","Hydro","Hidden","Sand","Balloon","Sunset","Winter","Summer","Mushroom","Iron","Coconut","Sea","Dynamite","Silver","Radical","Toe-Tapping","Twinkle","Final","Chaos","Pumpkin","Wild"],
